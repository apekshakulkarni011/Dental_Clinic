...
class RegistrationForm(Form):
    ssn = StringField("SSN(You May Use Mobile No", validators=[validators.length(min=10, max=15),
...
class BookAppointmentForm(Form):
    ...
    hour = SelectField("Available Hour's", validators=[validators.data_required(message="Please select an hour")])
